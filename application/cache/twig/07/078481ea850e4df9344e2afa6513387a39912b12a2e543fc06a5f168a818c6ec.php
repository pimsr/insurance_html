...
/* @f/agent-prudential.twig */
class __TwigTemplate_a1868fedad147c053411b0fb4c40fd64690756098890e9b8731c894b7dcef113 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout.twig", "@f/agent-prudential.twig", 1);
        $this->blocks = array(
 ...
 \t</section>
  <section class=\"content-p-top\">
     <div class=\"container\">
          ...
          <div class=\"agent\">
              <h3 class=\"title color-violet2 text-center\">ตัวแทน พรูเดนเชียล</h3>
        ...
        echo "icon/icon-link.png\">
                              ...
                              <li class=\"list-inline-item\">
                                  <a href=\"tel:02-201-1000\">เข้าสู่เว็บไซต์  พรูเดนเชียล</a>
                              </li>
                            </ul>
                          </div>
                        </div>
...
";
    ...
    {
        return "@f/agent-prudential.twig";
    }
  ...
  <section class=\"content-p-top\">
     <div class=\"container\">
          ...
          <div class=\"agent\">
              ...
              <div class=\"row my-5\">
                <div class=\"col-md-4 pr-5\">
                    <div class=\"staff-img\"><img class=\"img-fluid\" src=\"{{ link_img }}staff3.png\"></div>
                </div>
                <div class=\"col-md-8\">
                    <div class=\"\">
                      <div class=\"agent-info row px-5 py-5 \">
...
{% block js %}{% endblock %}", "@f/agent-prudential.twig", "/Applications/MAMP/htdocs/insurance/application/views/agent-prudential.twig");
    }
}
