...
/* @f/agent-aia.twig */
class __TwigTemplate_f0a3b549a2271bdb1ad6dfdf6dd8cc66dd02e0fd7a07d8209783c6b17150a5c8 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout.twig", "@f/agent-aia.twig", 1);
        $this->blocks = array(
 ...
 \t</section>
  <section class=\"content-p-top\">
     <div class=\"container\">
          ...
          <div class=\"agent\">
              <h3 class=\"title color-violet2 text-center\">ตัวแทน เอ ไอ เอ</h3>
        ...
        echo "icon/icon-link.png\">
                              ...
                              <li class=\"list-inline-item\">
                                  <a href=\"tel:02-201-1000\">เข้าสู่เว็บไซต์  เอ ไอ เอ</a>
                              </li>
                            </ul>
                          </div>
                        </div>
  ...
  <section class=\"content-p-top\">
     <div class=\"container\">
          ...
          <div class=\"agent\">
              ...
              <div class=\"row my-5\">
                <div class=\"col-md-4 pr-5\">
                    <div class=\"staff-img\"><img class=\"img-fluid\" src=\"{{ link_img }}staff1.png\"></div>
                </div>
                <div class=\"col-md-8\">
                    <div class=\"\">
                      <div class=\"agent-info row px-5 py-5 \">
...
{% block js %}{% endblock %}
", "@f/agent-aia.twig", "/Applications/MAMP/htdocs/insurance/application/views/agent-aia.twig");
    }
}
